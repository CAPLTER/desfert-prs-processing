...
summer_2018 <- read_excel('~/Desktop/Nutrient Supply Rate Data_ Project 1897_ Sally Wittlinger.xlsx',
                          skip = 5)
...
# SESSION: 2016 summer (full-suite) ----
